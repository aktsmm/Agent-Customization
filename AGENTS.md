...
| [vscode-environment.instructions.md](.github/instructions/dev/vscode-environment.instructions.md)  | VS Code 環境情報（ファイルパス、拡張機能ストレージ）                    |
...
| ファイル                                                                                                         | 説明                                       |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| [code-fix-error.prompt.md](.github/prompts/code-fix-error.prompt.md)                                             | エラー修正（原因特定→最小修正→確認）       |
| [code-hard-builder.prompt.md](.github/prompts/code-hard-builder.prompt.md)                                       | 高難度コード構築支援                       |
| [code-review.prompt.md](.github/prompts/code-review.prompt.md)                                                   | コードレビュー＋自動修正                   |
...
| [git-publish-policy.instructions.md](.github/prompts/git-publish-policy.instructions.md)                         | Git 公開同期ポリシー（手動参照用）         |
...
| [refine-product.prompt.md](.github/prompts/refine-product.prompt.md)                                             | 仕様起点の製品品質改善                     |
...
| [user-data-default.instructions.md](.github/prompts/user-data-default.instructions.md)                           | User Data customization の既定スコープ     |
