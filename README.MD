...
| `.github/prompts_sync/`           | グローバル用プロンプト（`export-session-dialogue`, `git-commit` 等）           |
...
/prompt export-session-dialogue      # セッション対話ログ・成果エクスポート
...
│   ├── export-session-dialogue.prompt.md
